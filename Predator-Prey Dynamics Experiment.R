...
# Export the dataset
write.table(Data11, file="Data_ARD.txt", sep="\t", row.names=F)
...
# Extract the dataset
write.table(Data12, file="Data_EXP1.txt", sep="\t", row.names=F)
...
# Import the dataset
Data11=read.table("Data_ARD.txt", h=T, dec=",")
...
# Extract the dataset
write.table(Data18, file="Data_EXP2.txt", sep="\t", row.names=F)
